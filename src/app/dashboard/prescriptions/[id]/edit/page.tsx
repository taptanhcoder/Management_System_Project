...
const samplePrescription: Prescription = {
  ...
  status: "Pending",
  medicines: [
    { name: "Paracetamol 500mg", quantity: 2, unitPrice: 5000 },
    { name: "Vitamin C 1000mg", quantity: 1, unitPrice: 10000 },
  ],
};
...
const EditPrescriptionPage = () => {
  ...
  const [prescription, setPrescription] = useState<Prescription>(samplePrescription);
    ...
    <div className="p-6 space-y-6">
      ...
      <nav aria-label="Breadcrumb" className="text-sm text-gray-500 dark:text-gray-400">
        <ol className="list-reset flex space-x-2">
          ...
          <li aria-current="page" className="text-gray-700 dark:text-white font-semibold">
            {id} &gt; Edit
          </li>
        </ol>
      </nav>

      <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Edit Prescription</h1>
